...
app = FastAPI(title="Simple Website API")
...
def read_items(skip: int = 0, limit: int = 100, current_user: models.User = Depends(get_current_user), db: Session = Depends(get_db)):
